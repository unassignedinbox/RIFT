...
//                                                      WORLDEDITORSEAT.CPP
//============================================================================================================================================
// 🧩 One composition, two hosts — the headless dumper and the windowed seat present the same tick.
...
void PresentWorldEditorSeat(RecordingSurface& Surface, const PlaneExtent& Desk, OutlinerPanel& Outliner,
